...
namespace Lactalis.Models {
	public class AgriSupplyDocumentEntityConfiguration : IEntityTypeConfiguration<AgriSupplyDocumentEntity>
	{
		public void Configure(EntityTypeBuilder<AgriSupplyDocumentEntity> builder)
		{
			...
			// % protected region % [Override AgriSupplyDocumentCategory AgriSupplyDocumentss configuration here] off begin
			builder
				.HasOne(e => e.AgriSupplyDocumentCategory)
				.WithMany(e => e.AgriSupplyDocumentss)
				.OnDelete(DeleteBehavior.Restrict);
			// % protected region % [Override AgriSupplyDocumentCategory AgriSupplyDocumentss configuration here] end
			// % protected region % [Override File configuration here] off begin
			builder
				.HasOne(e => e.File)
				.WithOne(e => e.AgriSupplyDocumentFile)
				.OnDelete(DeleteBehavior.SetNull);
			// % protected region % [Override File configuration here] end
