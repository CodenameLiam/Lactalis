...
namespace Lactalis.Models {
	public class TradingPostListingEntityConfiguration : IEntityTypeConfiguration<TradingPostListingEntity>
	{
		public void Configure(EntityTypeBuilder<TradingPostListingEntity> builder)
		{
			...
			// % protected region % [Override Farmer TradingPostListingss configuration here] off begin
			builder
				.HasOne(e => e.Farmer)
				.WithMany(e => e.TradingPostListingss)
				.OnDelete(DeleteBehavior.Restrict);
			// % protected region % [Override Farmer TradingPostListingss configuration here] end
			// % protected region % [Override ProductImage configuration here] off begin
			builder
				.HasOne(e => e.ProductImage)
				.WithOne(e => e.TradingPostListingProductImage)
				.OnDelete(DeleteBehavior.SetNull);
			// % protected region % [Override ProductImage configuration here] end
