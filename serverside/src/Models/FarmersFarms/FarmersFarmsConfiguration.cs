...
namespace Lactalis.Models {
	public class FarmersFarmsConfiguration : IEntityTypeConfiguration<FarmersFarms>
	{
		public void Configure(EntityTypeBuilder<FarmersFarms> builder)
		{
			...
			// % protected region % [Override Farmers configuration here] off begin
			builder
				.HasOne(e => e.Farmers)
				.WithMany(e => e.Farmss)
				.OnDelete(DeleteBehavior.Cascade);
			// % protected region % [Override Farmers configuration here] end

			// % protected region % [Override Farms configuration here] off begin
			builder
				.HasOne(e => e.Farms)
				.WithMany(e => e.Farmerss)
				.OnDelete(DeleteBehavior.Cascade);
			// % protected region % [Override Farms configuration here] end
