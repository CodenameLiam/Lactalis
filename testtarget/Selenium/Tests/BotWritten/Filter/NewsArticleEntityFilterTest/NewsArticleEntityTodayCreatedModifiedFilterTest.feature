...
@BotWritten @Filter
Feature: NewsArticleEntity filtered by today's created and modifed and search Feature

@NewsArticleEntity
Scenario: NewsArticleEntity filtered by today's created and modifed and search
