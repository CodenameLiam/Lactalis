...
@BotWritten @Filter
Feature: QualityDocumentCategoryEntity filtered by future's created and modifed and search Feature

@QualityDocumentCategoryEntity
Scenario: QualityDocumentCategoryEntity filtered by future's created and modifed and search
Given I login to the site as a user
Given I have 10 valid QualityDocumentCategoryEntity entities
And I have 1 valid QualityDocumentCategoryEntity entities with fixed string values BlaBla_StringToSearch_BlaBla
