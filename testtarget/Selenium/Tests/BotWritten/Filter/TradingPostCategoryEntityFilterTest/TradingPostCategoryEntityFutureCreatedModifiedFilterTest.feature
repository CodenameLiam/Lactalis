...
@BotWritten @Filter
Feature: TradingPostCategoryEntity filtered by future's created and modifed and search Feature

@TradingPostCategoryEntity
Scenario: TradingPostCategoryEntity filtered by future's created and modifed and search
