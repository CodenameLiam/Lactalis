...
@BotWritten @Filter
Feature: QualityDocumentEntity filtered by future's created and modifed and search Feature

@QualityDocumentEntity
Scenario: QualityDocumentEntity filtered by future's created and modifed and search
