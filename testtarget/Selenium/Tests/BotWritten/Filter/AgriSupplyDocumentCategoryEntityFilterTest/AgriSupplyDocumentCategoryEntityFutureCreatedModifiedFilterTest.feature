...
@BotWritten @Filter
Feature: AgriSupplyDocumentCategoryEntity filtered by future's created and modifed and search Feature

@AgriSupplyDocumentCategoryEntity
Scenario: AgriSupplyDocumentCategoryEntity filtered by future's created and modifed and search
