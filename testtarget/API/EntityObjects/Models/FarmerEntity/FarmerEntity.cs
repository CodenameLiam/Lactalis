...
{
	public class FarmerEntity : UserBaseEntity 
	{
		...
		public List<Guid> FarmsIds { get; set; }
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static FarmerEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static FarmerEntity GetInvalidEntity()
		{
			var farmerEntity = new FarmerEntity
			{
			};
			return farmerEntity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static FarmerEntity GetValidEntity(string fixedStrValue = null)
		{
			var farmerEntity = new FarmerEntity
			{
			};
