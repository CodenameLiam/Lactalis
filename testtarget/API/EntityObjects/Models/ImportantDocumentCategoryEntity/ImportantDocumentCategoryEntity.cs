...
{
	public class ImportantDocumentCategoryEntity : BaseEntity
	{
		// 
		...
		/// </summary>
		/// <see cref="Lactalis.Models.ImportantDocuments"/>
		public List<Guid> ImportantDocumentsIds { get; set; }
		...
		public ImportantDocumentCategoryEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static ImportantDocumentCategoryEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static ImportantDocumentCategoryEntity GetInvalidEntity()
		{
			var importantDocumentCategoryEntity = new ImportantDocumentCategoryEntity
			{
			};
			return importantDocumentCategoryEntity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static ImportantDocumentCategoryEntity GetValidEntity(string fixedStrValue = null)
		{
			var importantDocumentCategoryEntity = new ImportantDocumentCategoryEntity
			{
		...
		{
			return SaveToDB<Lactalis.Models.ImportantDocumentCategoryEntity>(ImportantDocumentCategoryEntityDto.Convert(this));
		}
	}
}
