...
namespace APITests.EntityObjects.Models
{
	public class PromotedArticlesEntity : BaseEntity
	{
		...
		/// </summary>
		/// <see cref="Lactalis.Models.NewsArticles"/>
		public List<Guid> NewsArticlesIds { get; set; }
		...
		public PromotedArticlesEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static PromotedArticlesEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static PromotedArticlesEntity GetInvalidEntity()
		{
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static PromotedArticlesEntity GetValidEntity(string fixedStrValue = null)
		{
			var promotedArticlesEntity = new PromotedArticlesEntity
			{
		...
		{
			return SaveToDB<Lactalis.Models.PromotedArticlesEntity>(PromotedArticlesEntityDto.Convert(this));
		}
	}
}
