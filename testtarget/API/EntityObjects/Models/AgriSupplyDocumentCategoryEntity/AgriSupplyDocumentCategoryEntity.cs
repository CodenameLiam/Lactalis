...
{
	public class AgriSupplyDocumentCategoryEntity : BaseEntity
	{
		// 
		...
		/// </summary>
		/// <see cref="Lactalis.Models.AgriSupplyDocuments"/>
		public List<Guid> AgriSupplyDocumentsIds { get; set; }
		...
		public AgriSupplyDocumentCategoryEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static AgriSupplyDocumentCategoryEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static AgriSupplyDocumentCategoryEntity GetInvalidEntity()
		{
			var agriSupplyDocumentCategoryEntity = new AgriSupplyDocumentCategoryEntity
			{
			};
			return agriSupplyDocumentCategoryEntity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static AgriSupplyDocumentCategoryEntity GetValidEntity(string fixedStrValue = null)
		{
			var agriSupplyDocumentCategoryEntity = new AgriSupplyDocumentCategoryEntity
			{
		...
		{
			return SaveToDB<Lactalis.Models.AgriSupplyDocumentCategoryEntity>(AgriSupplyDocumentCategoryEntityDto.Convert(this));
		}
	}
}
