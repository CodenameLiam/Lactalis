...
{
	public class QualityDocumentCategoryEntity : BaseEntity
	{
		// 
		...
		/// </summary>
		/// <see cref="Lactalis.Models.QualityDocuments"/>
		public List<Guid> QualityDocumentsIds { get; set; }
		...
		public QualityDocumentCategoryEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static QualityDocumentCategoryEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static QualityDocumentCategoryEntity GetInvalidEntity()
		{
			var qualityDocumentCategoryEntity = new QualityDocumentCategoryEntity
			{
			};
			return qualityDocumentCategoryEntity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static QualityDocumentCategoryEntity GetValidEntity(string fixedStrValue = null)
		{
			var qualityDocumentCategoryEntity = new QualityDocumentCategoryEntity
			{
		...
		{
			return SaveToDB<Lactalis.Models.QualityDocumentCategoryEntity>(QualityDocumentCategoryEntityDto.Convert(this));
		}
	}
}
