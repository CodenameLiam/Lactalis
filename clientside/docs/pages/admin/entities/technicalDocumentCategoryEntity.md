# TechnicalDocumentCategoryEntity Entity

Details regarding a given TechnicalDocumentCategoryEntity.
...
The list of records provided a means to see all of the TechnicalDocumentCategoryEntity found in the system. It is broken into pages with navigation between the pages available at the bottom of the list.

The list can be sorted based the the various attributes associated with the TechnicalDocumentCategoryEntity Entity by clicking the columns to sort the list either ascending or desending.
...
1. To create a new TechnicalDocumentCategoryEntity Entity entry click "Create new"
