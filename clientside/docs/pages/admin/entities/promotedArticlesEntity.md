...
# PromotedArticlesEntity Entity

Details regarding a given PromotedArticlesEntity.
...
| ---- | :----: | :--------: | :-----: | ----- | ----- |
| State | ENUMS.STATE | Sally | <i class="fa fa-times"> | <ul></ul> |  | 
...
The list of records provided a means to see all of the PromotedArticlesEntity found in the system. It is broken into pages with navigation between the pages available at the bottom of the list.

The list can be sorted based the the various attributes associated with the PromotedArticlesEntity Entity by clicking the columns to sort the list either ascending or desending.
...
1. To create a new PromotedArticlesEntity Entity entry click "Create new"
