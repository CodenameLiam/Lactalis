...
@observer
export default class TechnicalDocumentCategoryEntityPage extends React.Component<
	RouteComponentProps
> {
	public render() {
		let contents = null;
		...
		contents = (
			<PageWrapper {...this.props}>
				<EntityCRUD modelType={Models.TechnicalDocumentCategoryEntity} {...this.props} />
			</PageWrapper>
		);
