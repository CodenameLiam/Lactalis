...
@observer
export default class QualityDocumentEntityPage extends React.Component<RouteComponentProps> {
	public render() {
		let contents = null;

		contents = (
			<PageWrapper {...this.props}>
				<EntityCRUD modelType={Models.QualityDocumentEntity} {...this.props} />
			</PageWrapper>
		);
