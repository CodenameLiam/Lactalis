...
@observer
export default class AgriSupplyDocumentCategoryEntityPage extends React.Component<
	RouteComponentProps
> {
	public render() {
		let contents = null;
		...
		contents = (
			<PageWrapper {...this.props}>
				<EntityCRUD modelType={Models.AgriSupplyDocumentCategoryEntity} {...this.props} />
			</PageWrapper>
		);
