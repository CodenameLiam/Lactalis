...
@observer
export default class ImportantDocumentEntityPage extends React.Component<RouteComponentProps> {
	public render() {
		let contents = null;

		contents = (
			<PageWrapper {...this.props}>
				<EntityCRUD modelType={Models.ImportantDocumentEntity} {...this.props} />
			</PageWrapper>
		);
