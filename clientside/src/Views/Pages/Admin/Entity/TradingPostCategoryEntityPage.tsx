...
@observer
export default class TradingPostCategoryEntityPage extends React.Component<RouteComponentProps> {
	public render() {
		let contents = null;

		contents = (
			<PageWrapper {...this.props}>
				<EntityCRUD modelType={Models.TradingPostCategoryEntity} {...this.props} />
			</PageWrapper>
		);
