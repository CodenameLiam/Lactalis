...
@observer
export default class TechnicalDocumentEntityPage extends React.Component<RouteComponentProps> {
	public render() {
		let contents = null;

		contents = (
			<PageWrapper {...this.props}>
				<EntityCRUD modelType={Models.TechnicalDocumentEntity} {...this.props} />
			</PageWrapper>
		);
