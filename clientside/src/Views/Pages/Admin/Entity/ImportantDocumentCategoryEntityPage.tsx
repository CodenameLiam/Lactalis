...
@observer
export default class ImportantDocumentCategoryEntityPage extends React.Component<
	RouteComponentProps
> {
	public render() {
		let contents = null;
		...
		contents = (
			<PageWrapper {...this.props}>
				<EntityCRUD modelType={Models.ImportantDocumentCategoryEntity} {...this.props} />
			</PageWrapper>
		);
