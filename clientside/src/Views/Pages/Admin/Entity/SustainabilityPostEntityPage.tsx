...
@observer
export default class SustainabilityPostEntityPage extends React.Component<RouteComponentProps> {
	public render() {
		let contents = null;

		contents = (
			<PageWrapper {...this.props}>
				<EntityCRUD modelType={Models.SustainabilityPostEntity} {...this.props} />
			</PageWrapper>
		);
