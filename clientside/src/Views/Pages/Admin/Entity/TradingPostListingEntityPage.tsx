...
@observer
export default class TradingPostListingEntityPage extends React.Component<RouteComponentProps> {
	public render() {
		let contents = null;

		contents = (
			<PageWrapper {...this.props}>
				<EntityCRUD modelType={Models.TradingPostListingEntity} {...this.props} />
			</PageWrapper>
		);
