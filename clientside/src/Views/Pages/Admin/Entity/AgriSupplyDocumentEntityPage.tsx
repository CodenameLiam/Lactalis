...
@observer
export default class AgriSupplyDocumentEntityPage extends React.Component<RouteComponentProps> {
	public render() {
		let contents = null;

		contents = (
			<PageWrapper {...this.props}>
				<EntityCRUD modelType={Models.AgriSupplyDocumentEntity} {...this.props} />
			</PageWrapper>
		);
