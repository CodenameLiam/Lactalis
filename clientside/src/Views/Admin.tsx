			...
			<>
				...
				<div className="body-content">
					<Switch>
						...
						<Route path={`${path}/TradingPostListingEntity`} component={AdminPages.TradingPostListingEntityPage} />
						<Route path={`${path}/TradingPostCategoryEntity`} component={AdminPages.TradingPostCategoryEntityPage} />
						...
						<Route path={`${path}/ImportantDocumentCategoryEntity`} component={AdminPages.ImportantDocumentCategoryEntityPage} />
						<Route path={`${path}/QualityDocumentCategoryEntity`} component={AdminPages.QualityDocumentCategoryEntityPage} />
						<Route path={`${path}/TechnicalDocumentCategoryEntity`} component={AdminPages.TechnicalDocumentCategoryEntityPage} />
						<Route path={`${path}/QualityDocumentEntity`} component={AdminPages.QualityDocumentEntityPage} />
						<Route path={`${path}/TechnicalDocumentEntity`} component={AdminPages.TechnicalDocumentEntityPage} />
						<Route path={`${path}/ImportantDocumentEntity`} component={AdminPages.ImportantDocumentEntityPage} />
						<Route path={`${path}/NewsArticleEntity`} component={AdminPages.NewsArticleEntityPage} />
						<Route path={`${path}/PromotedArticlesEntity`} component={AdminPages.PromotedArticlesEntityPage} />
						<Route path={`${path}/AgriSupplyDocumentCategoryEntity`} component={AdminPages.AgriSupplyDocumentCategoryEntityPage} />
						<Route path={`${path}/SustainabilityPostEntity`} component={AdminPages.SustainabilityPostEntityPage} />
						<Route path={`${path}/AgriSupplyDocumentEntity`} component={AdminPages.AgriSupplyDocumentEntityPage} />
