...
@observer
class ModelAPIQuery<T extends Model, TData = any> extends React.Component<
	IModelAPIQueryProps<T, TData>
> {
	@observable
	...
	public componentDidUpdate() {
		if (
			...
			(!!this.props.pagination &&
				!!this.oldProps.pagination &&
				this.props.pagination.page !== this.oldProps.pagination.page)
		) {
	...
	private makeQuery = () => {
		...
		axios.get(url, { params: this.constructVariables }).then(this.onSuccess).catch(this.onError);
	};
