...
export default class QualityDocumentCategoryEntity extends Model implements IQualityDocumentCategoryEntityAttributes {
	...
	@CRUD({
		// % protected region % [Modify props to the crud options here for reference 'Quality Documents'] off begin
		...
		// % protected region % [Modify props to the crud options here for reference 'Quality Documents'] end
	})
	...
	public defaultExpands = `
		qualityDocumentss {
			...
			${Models.QualityDocumentEntity.getFiles().map(f => f.name).join('\n')}
		}
	`;
