...
export interface ITradingPostCategoryEntityAttributes extends IModelAttributes {
	...
	tradingPostListingss: Array<Models.TradingPostListingsTradingPostCategories | Models.ITradingPostListingsTradingPostCategoriesAttributes>;
...
export default class TradingPostCategoryEntity extends Model implements ITradingPostCategoryEntityAttributes {
			...
			if (attributes.tradingPostListingss) {
				for (const model of attributes.tradingPostListingss) {
					if (model instanceof Models.TradingPostListingsTradingPostCategories) {
						...
						this.tradingPostListingss.push(new Models.TradingPostListingsTradingPostCategories(model));
					}
				}
			}
