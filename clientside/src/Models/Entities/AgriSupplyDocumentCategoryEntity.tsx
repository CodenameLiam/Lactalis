...
export interface IAgriSupplyDocumentCategoryEntityAttributes extends IModelAttributes {
	...
	agriSupplyDocumentss: Array<Models.AgriSupplyDocumentEntity | Models.IAgriSupplyDocumentEntityAttributes>;
...
export default class AgriSupplyDocumentCategoryEntity extends Model implements IAgriSupplyDocumentCategoryEntityAttributes {
	...
	@CRUD({
		// % protected region % [Modify props to the crud options here for reference 'Agri Supply Documents'] off begin
		...
		// % protected region % [Modify props to the crud options here for reference 'Agri Supply Documents'] end
	})
	...
	public defaultExpands = `
		agriSupplyDocumentss {
			...
			${Models.AgriSupplyDocumentEntity.getFiles().map(f => f.name).join('\n')}
		}
	`;
